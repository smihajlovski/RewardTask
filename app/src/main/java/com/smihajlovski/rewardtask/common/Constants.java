...
public class Constants {
    ...
    public static final String APP_REWARD_TAG = "Reward App: ";
    public static final String BASE_URL = " http://hiring.rewardgateway.net/";
    public static final String EMPLOYEE_DATABASE_NAME = "employee_db";
